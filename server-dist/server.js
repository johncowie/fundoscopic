...
(function($PS) {
  ...
  var readNumber = function (s) {
      return Data_Either.note("[" + (s + "] is not a valid fund value"))(Data_Number.fromString(s));
  };
  var notEmpty = function (v) {
      if (v instanceof Data_List_Types.Nil) {
          return new Data_Either.Left("Funds cannot be empty");
      };
      return new Data_Either.Right(v);
  };
  var nonEmptyString = function (v) {
      if (v === "") {
          return new Data_Either.Left("Fund name cannot be empty");
      };
      return new Data_Either.Right(v);
  };
  ...
  var toColumns = function (v) {
      ...
      if (v instanceof Data_List_Types.Cons) {
          return Control_Bind.bind(Data_Either.bindEither)(headerPosition("Fund name")(v.value0))(function (fundNamePos) {
...
(function($PS) {
      ...
      return function (googleConfig) {
          return function (authedRequest) {
              ...
              return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Database_PostgreSQL.showPGError)))(Fundoscopic_DB.retrieveUser(v.sub)(db))))(function (userM) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.note("No user found for token: Id = " + Data_Show.show(Data_Show.showInt)(Data_Newtype.unwrap(Fundoscopic_Wrapper.newtypeWrapper)(v.sub)))(userM))))(function (user) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Fundoscopic_Google_Sheets.sheetValues(googleConfig)(Fundoscopic_Wrapper.rewrap(Fundoscopic_Wrapper.newtypeWrapper)(JohnCowie_JWT.newtypeJWT)(user.accessToken))(Fundoscopic_Wrapper.rewrap(Fundoscopic_Wrapper.newtypeWrapper)(JohnCowie_JWT.newtypeJWT)(user.refreshToken))("14VnAjVSNy1cuPFgzcLlYY3q1qP2GW_uSSBKEs_M1GgM")("Data!A:B")))(function (sheetData) {
                          var processedData = Fundoscopic_Data_Fund.readInvestments(sheetData);
                          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(JohnCowie_HTTPure.response(200)(Data_Show.show(Data_Either.showEither(Data_Show.showString)(Data_List_Types.showList(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                              return "name";
                          }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                              return "value";
                          }))(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showString)))))(processedData)));
                      });
                  });
              }));
          };
  ...
  var htmlResponse = function (status) {
      var $16 = JohnCowie_HTTPure.setContentType("text/html");
      var $17 = JohnCowie_HTTPure.response(status);
      return function ($18) {
          return $16($17(Text_Smolder_Renderer_String.render($18)));
      };
  };
...
(function($PS) {
  ...
  var migrations = [ createOAuthUserTable(1), addRefreshTokenColumn(2) ];
      ...
      return function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v.value0 instanceof Fundoscopic_Routing.SheetTest) {
                  return Fundoscopic_Middleware_Auth.wrapTokenAuth(JohnCowie_JWT.newtypeJWT)(deps.jwt.verifyAndExtract)(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)(loginRedirect)))(JohnCowie_HTTPure_Middleware_QueryParams.wrapParseQueryParams(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsNil)()(Effect_Aff.bindAff)(Effect_Aff.applicativeAff)(Fundoscopic_Middleware_Auth.functorAuthedRequest)(Fundoscopic_Middleware_Auth.requestAuthedRequest)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.pure(Effect_Aff.applicativeAff))(errorsResponse))(JohnCowie_HTTPure_Middleware_Error.wrapHandleError(Effect_Aff.monadAff)(serverErrorResponse)(Fundoscopic_Handlers.spreadsheet(deps.db)(deps.oauth.config))));
              };
              throw new Error("Failed pattern match at Main (line 54, column 14 - line 65, column 59): " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 52, column 22 - line 65, column 59): " + [ v.constructor.name ]);
      };
  };
      ...
      return Effect_Aff.launchAff_(logError(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Either.Right.create)(Node_Process.getEnv))))(function (env) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Envisage_Console.printErrorsForConsole)(Envisage_Internal.readEnv()()(Envisage_Record.recordUpdateCons(new Data_Symbol.IsSymbol(function () {
              ...
              oauth: (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 104, column 14 - line 106, column 71): " + [ mode.constructor.name ]);
              })(),
              server: serverConfig,
