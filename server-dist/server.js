...
(function($PS) {
  ...
  var retrieveUser = function (userId) {
      return Data_Function.flip(JohnCowie_PostgreSQL.runQuery)(function (conn) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Database_PostgreSQL_PG.query(Database_PostgreSQL_Row.toSQLRowRow1(Fundoscopic_Wrapper.toSQLValue(Database_PostgreSQL_Value.toSQLValueInt)))(Database_PostgreSQL_Row.fromSQLRowTuple(Database_PostgreSQL_Value.fromSQLValueString)(Database_PostgreSQL_Row.fromSQLRowTupleTwo(Fundoscopic_Wrapper.fromSQLValue(Database_PostgreSQL_Value.fromSQLValueString))(Fundoscopic_Wrapper.fromSQLValue(Database_PostgreSQL_Value.fromSQLValueString))))(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff))(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(conn)("\x0a        SELECT google_id, name, access_token FROM users\x0a        WHERE id = $1;\x0a      ")(new Database_PostgreSQL_Row.Row1(userId)))(function (rows) {
              if (rows.length === 1) {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(Data_Maybe.Just.create(Fundoscopic_Data_User.withId(userId)(Fundoscopic_Data_User.newUser(rows[0].value0)(rows[0].value1.value0)(rows[0].value1.value1))));
              };
...
(function($PS) {
  ...
  var sheetValues = function (authConfig) {
      return function (token) {
          return function (spreadsheetId) {
              return function (range) {
                  var auth = $foreign["_auth"](authConfig.clientId)(authConfig.clientSecret)(authConfig.callbackUrl)(Data_Newtype.unwrap(JohnCowie_JWT.newtypeJWT)(token));
          ...
          return function (authedRequest) {
              ...
              return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Database_PostgreSQL.showPGError)))(Fundoscopic_DB.retrieveUser(v.sub)(db))))(function (userM) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.note("No user found for token: Id = " + Data_Show.show(Data_Show.showInt)(Data_Newtype.unwrap(Fundoscopic_Wrapper.newtypeWrapper)(v.sub)))(userM))))(function (user) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Fundoscopic_Google_Sheets.sheetValues(googleConfig)(Fundoscopic_Wrapper.rewrap(Fundoscopic_Wrapper.newtypeWrapper)(JohnCowie_JWT.newtypeJWT)(user.accessToken))("1WjWrck5uJYcLFvleNedzrWSx9vsEYMFEl1MuUc8x7PQ")("Game 1!A1:F5")))(function (sheetData) {
                          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(JohnCowie_HTTPure.response(200)(Data_Show.show(Data_Show.showArray(Data_Show.showArray(Data_Show.showString)))(sheetData)));
                      });
                  });
              }));
          };
          ...
          return function (jwtGen) {
              return function (req) {
                  ...
                  return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(oauth.handleCode(v.value0.code)))(function (userData) {
                      var newUser = Fundoscopic_Data_User.newUser(userData.name)(Fundoscopic_Data_User.newGoogleId(userData.sub))(Fundoscopic_Data_User.newGoogleAccessToken(userData.accessToken));
      ...
      return function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v.value0 instanceof Fundoscopic_Routing.SheetTest) {
                  return Fundoscopic_Middleware_Auth.wrapTokenAuth(JohnCowie_JWT.newtypeJWT)(deps.jwt.verifyAndExtract)(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)(loginRedirect)))(JohnCowie_HTTPure_Middleware_Error.wrapHandleError(Effect_Aff.monadAff)(serverErrorResponse)(Fundoscopic_Handlers.spreadsheet(deps.db)(deps.oauth.config)));
              };
              throw new Error("Failed pattern match at Main (line 54, column 14 - line 64, column 59): " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 52, column 22 - line 64, column 59): " + [ v.constructor.name ]);
      };
  };
      ...
      return Effect_Aff.launchAff_(logError(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Either.Right.create)(Node_Process.getEnv))))(function (env) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Envisage_Console.printErrorsForConsole)(Envisage_Internal.readEnv()()(Envisage_Record.recordUpdateCons(new Data_Symbol.IsSymbol(function () {
              ...
              oauth: (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 103, column 14 - line 105, column 29): " + [ mode.constructor.name ]);
              })(),
              server: serverConfig,
