...
})(PS["Data.TemplateString"] = PS["Data.TemplateString"] || {});
(function(exports) {
...
})(PS["Data.TemplateString.Unsafe"] = PS["Data.TemplateString.Unsafe"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.TemplateString.Unsafe"] = $PS["Data.TemplateString.Unsafe"] || {};
  var exports = $PS["Data.TemplateString.Unsafe"];
  var $foreign = $PS["Data.TemplateString.Unsafe"];
  var Data_Function_Uncurried = $PS["Data.Function.Uncurried"];                
  var templateBy = Data_Function_Uncurried.runFn3($foreign["_templateBy"]);
  exports["templateBy"] = templateBy;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.TemplateString"] = $PS["Data.TemplateString"] || {};
  var exports = $PS["Data.TemplateString"];
  var $foreign = $PS["Data.TemplateString"];
  var Data_TemplateString_Unsafe = $PS["Data.TemplateString.Unsafe"];
  var template = function (tmpl) {
      var $2 = Data_TemplateString_Unsafe.templateBy(function (v) {
          return "!" + v;
      })(tmpl);
      return function ($3) {
          return $2($foreign["_buildExclamationKeyObject"]($3));
      };
  };
...
(function($PS) {
  ...
  var fromSQLValueString = new FromSQLValue((function () {
      var $35 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError)));
      return function ($36) {
          return $35(Control_Monad_Except.runExcept(Foreign.readString($36)));
      };
  })());
...
(function($PS) {
  ...
  var fromSQLRowTupleTwo = function (dictFromSQLValue) {
      return function (dictFromSQLValue1) {
          return new FromSQLRow(function (v) {
              if (v.length === 2) {
                  return Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(Data_Tuple.Tuple.create)(Database_PostgreSQL_Value.fromSQLValue(dictFromSQLValue)(v[0])))(Database_PostgreSQL_Value.fromSQLValue(dictFromSQLValue1)(v[1]));
              };
              return new Data_Either.Left("Expecting exactly two more fields.");
          });
      };
  };
  ...
  exports["fromSQLRowTupleTwo"] = fromSQLRowTupleTwo;
...
(function($PS) {
  ...
  var rewrap = function (dictNewtype) {
      return function (dictNewtype1) {
          var $31 = Data_Newtype.wrap(dictNewtype1);
          var $32 = Data_Newtype.unwrap(dictNewtype);
          return function ($33) {
              return $31($32($33));
          };
      };
  ...
  var toSQLValue = function (dictToSQLValue) {
      return new Database_PostgreSQL_Value.ToSQLValue((function () {
          var $34 = Database_PostgreSQL_Value.toSQLValue(dictToSQLValue);
          var $35 = Data_Newtype.unwrap(newtypeWrapper);
          return function ($36) {
              return $34($35($36));
          };
      })());
  ...
  var fromSQLValue = function (dictFromSQLValue) {
      return new Database_PostgreSQL_Value.FromSQLValue((function () {
          var $37 = Data_Functor.map(Data_Either.functorEither)(Data_Newtype.wrap(newtypeWrapper));
          var $38 = Database_PostgreSQL_Value.fromSQLValue(dictFromSQLValue);
          return function ($39) {
              return $37($38($39));
          };
      })());
  ...
  var encodeJsonWrapper = function (dictEncodeJson) {
      return new Data_Argonaut_Encode_Class.EncodeJson((function () {
          var $40 = Data_Argonaut_Encode_Class.encodeJson(dictEncodeJson);
          var $41 = Data_Newtype.unwrap(newtypeWrapper);
          return function ($42) {
              return $40($41($42));
          };
      })());
  ...
  var decodeJsonWrapper = function (dictDecodeJson) {
      return new Data_Argonaut_Decode_Class.DecodeJson((function () {
          var $43 = Data_Functor.map(Data_Either.functorEither)(Data_Newtype.wrap(newtypeWrapper));
          var $44 = Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson);
          return function ($45) {
              return $43($44($45));
          };
      })());
...
(function($PS) {
  "use strict";
  $PS["Fundoscopic.Data.User"] = $PS["Fundoscopic.Data.User"] || {};
  var exports = $PS["Fundoscopic.Data.User"];
  var Data_Newtype = $PS["Data.Newtype"];
...
(function($PS) {
  ...
  var Data_Show = $PS["Data.Show"];
  var Data_String_Common = $PS["Data.String.Common"];
  var Data_TemplateString = $PS["Data.TemplateString"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Database_PostgreSQL = $PS["Database.PostgreSQL"];
  var Database_PostgreSQL_PG = $PS["Database.PostgreSQL.PG"];
  var Database_PostgreSQL_Row = $PS["Database.PostgreSQL.Row"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  var Fundoscopic_Data_User = $PS["Fundoscopic.Data.User"];
  var Fundoscopic_Wrapper = $PS["Fundoscopic.Wrapper"];
  var JohnCowie_PostgreSQL = $PS["JohnCowie.PostgreSQL"];                
  var SQLValueString = (function () {
      function SQLValueString(value0) {
          this.value0 = value0;
      };
      SQLValueString.create = function (value0) {
          return new SQLValueString(value0);
      };
      return SQLValueString;
  })();
  var ShowSQLValue = function (showSQLValue) {
      this.showSQLValue = showSQLValue;
  };
  var upsertUser = function (user) {
      return Data_Function.flip(JohnCowie_PostgreSQL.runQuery)(function (conn) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Database_PostgreSQL_PG.query(Database_PostgreSQL_Row.toSQLRowTuple(Fundoscopic_Wrapper.toSQLValue(Database_PostgreSQL_Value.toSQLValueString))(Database_PostgreSQL_Row.toSQLRowTuple(Database_PostgreSQL_Value.toSQLValueString)(Database_PostgreSQL_Row.toSQLRowTupleTwo(Fundoscopic_Wrapper.toSQLValue(Database_PostgreSQL_Value.toSQLValueString))(Fundoscopic_Wrapper.toSQLValue(Database_PostgreSQL_Value.toSQLValueString)))))(Database_PostgreSQL_Row.fromSQLRowRow1(Fundoscopic_Wrapper.fromSQLValue(Database_PostgreSQL_Value.fromSQLValueInt)))(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff))(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(conn)("\x0a              INSERT INTO users (google_id, name, access_token, refresh_token) VALUES ($1, $2, $3, $4)\x0a              ON CONFLICT ON CONSTRAINT users_google_id_key\x0a              DO UPDATE SET name = $2, access_token = $3, refresh_token = $4\x0a              RETURNING id;\x0a              ")(new Data_Tuple.Tuple(user.googleId, new Data_Tuple.Tuple(user.name, new Data_Tuple.Tuple(user.accessToken, user.refreshToken)))))(function (rows) {
              if (rows.length === 1) {
  ...
  var showSVS = function (v) {
      return v.value0;
  };
  var showSQLValueString = new ShowSQLValue(function (s) {
      return SQLValueString.create("'" + (s + "'"));
  });
  var showSQLValueNumber = new ShowSQLValue((function () {
      var $14 = Data_Show.show(Data_Show.showNumber);
      return function ($15) {
          return SQLValueString.create($14($15));
      };
  })());
  var showSQLValueInt = new ShowSQLValue((function () {
      var $16 = Data_Show.show(Data_Show.showInt);
      return function ($17) {
          return SQLValueString.create($16($17));
      };
  })());
  var showSQLValue = function (dict) {
      return dict.showSQLValue;
  };
  var retrieveUser = function (userId) {
      return Data_Function.flip(JohnCowie_PostgreSQL.runQuery)(function (conn) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Database_PostgreSQL_PG.query(Database_PostgreSQL_Row.toSQLRowRow1(Fundoscopic_Wrapper.toSQLValue(Database_PostgreSQL_Value.toSQLValueInt)))(Database_PostgreSQL_Row.fromSQLRowTuple(Database_PostgreSQL_Value.fromSQLValueString)(Database_PostgreSQL_Row.fromSQLRowTuple(Fundoscopic_Wrapper.fromSQLValue(Database_PostgreSQL_Value.fromSQLValueString))(Database_PostgreSQL_Row.fromSQLRowTupleTwo(Fundoscopic_Wrapper.fromSQLValue(Database_PostgreSQL_Value.fromSQLValueString))(Fundoscopic_Wrapper.fromSQLValue(Database_PostgreSQL_Value.fromSQLValueString)))))(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff))(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(conn)("\x0a        SELECT google_id, name, access_token, refresh_token FROM users\x0a        WHERE id = $1;\x0a      ")(new Database_PostgreSQL_Row.Row1(userId)))(function (rows) {
              if (rows.length === 1) {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(Data_Maybe.Just.create(Fundoscopic_Data_User.withId(userId)(Fundoscopic_Data_User.newUser(rows[0].value0)(rows[0].value1.value0)(rows[0].value1.value1.value0)(rows[0].value1.value1.value1))));
              };
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(Data_Maybe.Nothing.value);
          });
      });
  };
  var investmentToRow = function (fundName) {
      return function (investment) {
          return [ showSQLValue(showSQLValueString)(fundName), showSQLValue(showSQLValueInt)(2020), showSQLValue(showSQLValueString)(investment.name), showSQLValue(showSQLValueNumber)(investment.value) ];
      };
  };
  var deleteFund = function (fundName) {
      return Data_Function.flip(JohnCowie_PostgreSQL.runQuery)(function (conn) {
          return Database_PostgreSQL_PG.execute(Database_PostgreSQL_Row.toSQLRowRow1(Database_PostgreSQL_Value.toSQLValueString))(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff))(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(conn)("\x0a      DELETE FROM investments WHERE local_authority = $1;\x0a    ")(new Database_PostgreSQL_Row.Row1(fundName));
      });
  };

  //---
  var bulkInsert = function (tableName) {
      return function (columns) {
          return function (rowF) {
              return function (rows) {
                  var rowStr = function (row) {
                      return "(" + (Data_String_Common.joinWith(", ")(Data_Functor.map(Data_Functor.functorArray)(showSVS)(rowF(row))) + ")");
                  };
                  var values = Data_String_Common.joinWith(", \x0a")(Data_Functor.map(Data_Functor.functorArray)(rowStr)(rows));
                  var columnNames = Data_String_Common.joinWith(", ")(columns);
                  return Database_PostgreSQL.Query(Data_TemplateString.template("\x0a  INSERT INTO ${tableName} (${columns})\x0a  VALUES ${values};\x0a  ")([ new Data_Tuple.Tuple("tableName", tableName), new Data_Tuple.Tuple("columns", columnNames), new Data_Tuple.Tuple("values", values) ]));
              };
          };
      };
  };
  var insertFund = function (fund) {
      return Data_Function.flip(JohnCowie_PostgreSQL.runQuery)(function (conn) {
          return Database_PostgreSQL_PG.execute(Database_PostgreSQL_Row.toSQLRowRow0)(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff))(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(conn)(bulkInsert("investments")([ "local_authority", "year", "investment", "value" ])(investmentToRow(fund.name))(fund.investments))(Database_PostgreSQL_Row.Row0.value);
      });
  };
  var upsertFund = function (fund) {
      return function (db) {
          return Control_Monad_Except_Trans.runExceptT(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(deleteFund(fund.name)(db)))(function () {
              return Control_Monad_Except_Trans.ExceptT(insertFund(fund)(db));
          }));
      };
  };
  exports["upsertUser"] = upsertUser;
  exports["retrieveUser"] = retrieveUser;
  exports["upsertFund"] = upsertFund;
})(PS);
(function($PS) {
  "use strict";
  $PS["Fundoscopic.Data.Fund"] = $PS["Fundoscopic.Data.Fund"] || {};
  var exports = $PS["Fundoscopic.Data.Fund"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var Data_Tuple = $PS["Data.Tuple"];
  var Data_Unfoldable = $PS["Data.Unfoldable"];                
  var readNumber = function (s) {
      return Data_Either.note("[" + (s + "] is not a valid investment value"))(Data_Number.fromString(s));
  };
  var notEmpty = function (v) {
      if (v instanceof Data_List_Types.Nil) {
          return new Data_Either.Left("Investments cannot be empty");
      };
      return new Data_Either.Right(v);
  };
  var nonEmptyString = function (v) {
      if (v === "") {
          return new Data_Either.Left("Investment name cannot be empty");
      };
      return new Data_Either.Right(v);
  };
  var readInvestment = function (v) {
      return Control_Bind.bind(Data_Either.bindEither)(nonEmptyString(v.value0))(function (name) {
          return Control_Bind.bind(Data_Either.bindEither)(readNumber(v.value1))(function (value) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  name: name,
                  value: value
              });
  ...
  var mkFund = function (name) {
      return function (investments) {
          return {
              name: name,
              investments: Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(investments)
          };
      };
  };
  var isBlankString = function (s) {
      return Data_String_Common.trim(s) === "";
  };
  var removeBlankRows = Data_List.filter(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Foldable.all(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(isBlankString)));
  var headerPosition = function (header) {
      var $18 = Data_Either.note("No column with header " + header);
      var $19 = Data_List.elemIndex(Data_Eq.eqString)(Data_String_Common.toLower(header));
      var $20 = Data_Functor.map(Data_List_Types.functorList)(Data_String_Common.toLower);
      return function ($21) {
          return $18($19($20($21)));
      };
  };
  var gatherRowValues = function (v) {
      return function (row) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Not enough values in row")(Data_List.index(row)(v.fundNamePos)))(function (fundName) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Not enough values in row")(Data_List.index(row)(v.fundValuePos)))(function (fundValue) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(fundName, fundValue));
              });
          });
      };
  };
  var toColumns = function (v) {
      if (v instanceof Data_List_Types.Nil) {
          return new Data_Either.Left("Sheet has no data");
      };
      if (v instanceof Data_List_Types.Cons) {
          return Control_Bind.bind(Data_Either.bindEither)(headerPosition("Investment")(v.value0))(function (fundNamePos) {
              return Control_Bind.bind(Data_Either.bindEither)(headerPosition("value")(v.value0))(function (fundValuePos) {
                  return Data_Traversable["for"](Data_Either.applicativeEither)(Data_List_Types.traversableList)(v.value1)(gatherRowValues({
                      fundNamePos: fundNamePos,
                      fundValuePos: fundValuePos
                  }));
              });
          });
      };
      throw new Error("Failed pattern match at Fundoscopic.Data.Fund (line 27, column 1 - line 27, column 78): " + [ v.constructor.name ]);
  };
  var readInvestments$prime = Control_Bind.composeKleisli(Data_Either.bindEither)(function ($22) {
      return toColumns(removeBlankRows($22));
  })(Control_Bind.composeKleisli(Data_Either.bindEither)((function () {
      var $23 = Data_Traversable.sequence(Data_List_Types.traversableList)(Data_Either.applicativeEither);
      var $24 = Data_Functor.map(Data_List_Types.functorList)(readInvestment);
      return function ($25) {
          return $23($24($25));
      };
  })())(notEmpty));
  var aToL = (function () {
      ...
      var $27 = Data_Functor.map(Data_Functor.functorArray)(Data_List.fromFoldable(Data_Foldable.foldableArray));
      return function ($28) {
          return $26($27($28));
      };
  })();
  var readInvestments = function ($29) {
      return readInvestments$prime(aToL($29));
  };
  exports["readInvestments"] = readInvestments;
  exports["mkFund"] = mkFund;
})(PS);
(function($PS) {
  "use strict";
  $PS["Fundoscopic.Prelude"] = $PS["Fundoscopic.Prelude"] || {};
  var exports = $PS["Fundoscopic.Prelude"];
  var Effect_Console = $PS["Effect.Console"];
  var console = {
      log: Effect_Console.log,
      error: Effect_Console.error
  };
...
(function($PS) {
  ...
  var _method = function (dict) {
      return dict["_method"];
  };
  var _httpVersion = function (dict) {
      return dict["_httpVersion"];
  };
  ...
  var _body = function (dict) {
      return dict["_body"];
  };
  exports["IsRequest"] = IsRequest;
  exports["_headers"] = _headers;
  exports["_httpVersion"] = _httpVersion;
...
(function($PS) {
  "use strict";
  $PS["Fundoscopic.Error"] = $PS["Fundoscopic.Error"] || {};
  var exports = $PS["Fundoscopic.Error"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Data_Bifunctor = $PS["Data.Bifunctor"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Fundoscopic_Prelude = $PS["Fundoscopic.Prelude"];
  var JohnCowie_HTTPure = $PS["JohnCowie.HTTPure"];                
  var UserError = (function () {
      function UserError(value0) {
          this.value0 = value0;
      };
      UserError.create = function (value0) {
          return new UserError(value0);
      };
      return UserError;
  })();
  ...
  var userError = UserError.create;
  var toUserError = function (dictFunctor) {
      var $6 = Data_Functor.map(dictFunctor)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(UserError.create));
      return function ($7) {
          return Control_Monad_Except_Trans.ExceptT($6(Control_Monad_Except_Trans.runExceptT($7)));
      };
  };
  var toServerError = function (dictFunctor) {
      var $8 = Data_Functor.map(dictFunctor)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(ServerError.create));
      return function ($9) {
          return Control_Monad_Except_Trans.ExceptT($8(Control_Monad_Except_Trans.runExceptT($9)));
      };
  };                                   
  var plainErrorResponse = function (v) {
      if (v instanceof UserError) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(JohnCowie_HTTPure.response(400)(v.value0));
      };
      if (v instanceof ServerError) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Fundoscopic_Prelude.console.error(v.value0)))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(JohnCowie_HTTPure.response(500)("[server error]"));
          });
      };
      throw new Error("Failed pattern match at Fundoscopic.Error (line 20, column 1 - line 20, column 57): " + [ v.constructor.name ]);
  };
  exports["userError"] = userError;
  exports["toUserError"] = toUserError;
  exports["toServerError"] = toServerError;
  exports["plainErrorResponse"] = plainErrorResponse;
})(PS);
(function(exports) {
...
})(PS["Fundoscopic.Google.Sheets"] = PS["Fundoscopic.Google.Sheets"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  "use strict";
  $PS["Fundoscopic.Google.Sheets"] = $PS["Fundoscopic.Google.Sheets"] || {};
  var exports = $PS["Fundoscopic.Google.Sheets"];
  var $foreign = $PS["Fundoscopic.Google.Sheets"];
  var Control_Monad_Error_Class = $PS["Control.Monad.Error.Class"];
  var Data_Bifunctor = $PS["Data.Bifunctor"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Effect_Aff_Compat = $PS["Effect.Aff.Compat"];
  var Effect_Exception = $PS["Effect.Exception"];
  var Fundoscopic_Error = $PS["Fundoscopic.Error"];
  var JohnCowie_JWT = $PS["JohnCowie.JWT"];                
  var sheetValues = function (authConfig) {
      return function (token) {
          return function (refreshToken) {
              return function (spreadsheetId) {
                  return function (range) {
                      var creds = {
                          access_token: Data_Newtype.unwrap(JohnCowie_JWT.newtypeJWT)(token),
                          refresh_token: Data_Newtype.unwrap(JohnCowie_JWT.newtypeJWT)(refreshToken)
                      };
                      var auth = $foreign["_auth"](authConfig.clientId)(authConfig.clientSecret)(authConfig.callbackUrl)(creds);
                      return Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Effect_Exception.showError)))(Control_Monad_Error_Class["try"](Effect_Aff.monadErrorAff)(Effect_Aff_Compat.fromEffectFnAff($foreign["_sheetValues"](auth)(spreadsheetId)(range))));
                  };
              };
          };
      };
  };
  var lowerContains = function (a) {
      return function (b) {
          return Data_String_CodeUnits.contains(Data_String_Pattern.Pattern(Data_String_Common.toLower(a)))(Data_String_Common.toLower(b));
      };
  };
  var toHttpError = function (sheetError) {
      if (lowerContains("Unable to parse range")(sheetError)) {
          return Fundoscopic_Error.userError("Sheet does not exist");
      };
      if (lowerContains("Requested entity was not found")(sheetError)) {
          return Fundoscopic_Error.userError("Spreadsheet does not exist");
      };
      if (Data_Boolean.otherwise) {
          return Fundoscopic_Error.userError("don't know what happened");
      };
      throw new Error("Failed pattern match at Fundoscopic.Google.Sheets (line 25, column 1 - line 25, column 35): " + [ sheetError.constructor.name ]);
  };
  var refineSheetErrors = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(toHttpError);
  exports["sheetValues"] = sheetValues;
  exports["refineSheetErrors"] = refineSheetErrors;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var functorAuthedRequest = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new AuthedRequest(m.value0, Data_Functor.map(JohnCowie_HTTPure.functorBasicRequest)(f)(m.value1));
      };
  });
  var _underlyingRequest = (function () {
      var setter = function (v) {
          return function (req) {
              return new AuthedRequest(v.value0, req);
          };
      };
      var getter = function (v) {
          return v.value1;
      };
      return JohnCowie_Data_Lens.lens(getter)(setter);
  })();
  var requestAuthedRequest = new JohnCowie_HTTPure.IsRequest(Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_body"](JohnCowie_HTTPure.requestBasicRequest)), Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_headers"](JohnCowie_HTTPure.requestBasicRequest)), Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_httpVersion"](JohnCowie_HTTPure.requestBasicRequest)), Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_method"](JohnCowie_HTTPure.requestBasicRequest)), Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_path"](JohnCowie_HTTPure.requestBasicRequest)), Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_query"](JohnCowie_HTTPure.requestBasicRequest)), Control_Semigroupoid.composeFlipped(JohnCowie_Data_Lens.lensSemigroupoid)(_underlyingRequest)(JohnCowie_HTTPure["_val"](JohnCowie_HTTPure.requestBasicRequest)));
  exports["wrapTokenAuth"] = wrapTokenAuth;
  exports["tokenPayload"] = tokenPayload;
  exports["requestAuthedRequest"] = requestAuthedRequest;
  exports["functorAuthedRequest"] = functorAuthedRequest;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var SheetTest = (function () {
      function SheetTest() {

      };
      SheetTest.value = new SheetTest();
      return SheetTest;
  })();
  ...
  var routeForHandler = function (v) {
      ...
      if (v instanceof SheetTest) {
          return joinPath([ "sheet" ]);
      };
      if (v instanceof Home) {
          return joinPath([  ]);
      };
      throw new Error("Failed pattern match at Fundoscopic.Routing (line 26, column 1 - line 26, column 39): " + [ v.constructor.name ]);
  };
  var handlerIdForPath = function (v) {
      ...
      if (v.length === 1 && v[0] === "sheet") {
          return new Data_Maybe.Just(SheetTest.value);
      };
      if (v.length === 0) {
...
(function($PS) {
  ...
  var Fundoscopic_Data_Fund = $PS["Fundoscopic.Data.Fund"];
  var Fundoscopic_Data_User = $PS["Fundoscopic.Data.User"];
  var Fundoscopic_Error = $PS["Fundoscopic.Error"];
  var Fundoscopic_Google_Sheets = $PS["Fundoscopic.Google.Sheets"];
  ...
  var spreadsheet = function (db) {
      return function (googleConfig) {
          return function (authedRequest) {
              var v = Fundoscopic_Middleware_Auth.tokenPayload(authedRequest);
              var v1 = JohnCowie_Data_Lens.view(JohnCowie_HTTPure["_val"](Fundoscopic_Middleware_Auth.requestAuthedRequest))(authedRequest);
              return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Fundoscopic_Error.toServerError(Effect_Aff.functorAff)(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Database_PostgreSQL.showPGError)))(Fundoscopic_DB.retrieveUser(v.sub)(db)))))(function (userM) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Fundoscopic_Error.toServerError(Effect_Aff.functorAff)(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.note("No user found for token: Id = " + Data_Show.show(Data_Show.showInt)(Data_Newtype.unwrap(Fundoscopic_Wrapper.newtypeWrapper)(v.sub)))(userM)))))(function (user) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Fundoscopic_Google_Sheets.refineSheetErrors)(Fundoscopic_Google_Sheets.sheetValues(googleConfig)(Fundoscopic_Wrapper.rewrap(Fundoscopic_Wrapper.newtypeWrapper)(JohnCowie_JWT.newtypeJWT)(user.accessToken))(Fundoscopic_Wrapper.rewrap(Fundoscopic_Wrapper.newtypeWrapper)(JohnCowie_JWT.newtypeJWT)(user.refreshToken))(v1.value0.spreadsheet_sheet_id)(v1.value0.sheet_name + "!A:B"))))(function (sheetData) {
                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Fundoscopic_Error.toUserError(Effect_Aff.functorAff)(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Fundoscopic_Data_Fund.readInvestments(sheetData)))))(function (investments) {
                              var fund = Fundoscopic_Data_Fund.mkFund(v1.value0.fund_name)(investments);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Fundoscopic_Error.toServerError(Effect_Aff.functorAff)(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Database_PostgreSQL.showPGError)))(Fundoscopic_DB.upsertFund(fund)(db)))))(function () {
                                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(JohnCowie_HTTPure.response(200)(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                      return "investments";
                                  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                      return "name";
                                      ...
                                      return "value";
                                  }))(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showString))))))(fund)));
                              });
                          });
                      });
                  });
  ...
  var htmlResponse = function (status) {
      var $23 = JohnCowie_HTTPure.setContentType("text/html");
      var $24 = JohnCowie_HTTPure.response(status);
      return function ($25) {
          return $23($24(Text_Smolder_Renderer_String.render($25)));
      };
  };
          ...
          return function (jwtGen) {
              return function (req) {
                  ...
                  return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(oauth.handleCode(v.value0.code)))(function (userData) {
                      var newUser = Fundoscopic_Data_User.newUser(userData.name)(Fundoscopic_Data_User.newGoogleId(userData.sub))(Fundoscopic_Data_User.newGoogleAccessToken(userData.accessToken))(Data_Newtype.wrap(Fundoscopic_Wrapper.newtypeWrapper)(userData.refreshToken));
...
(function($PS) {
  ...
  var createInvestmentsTable = function (id) {
      return {
          id: id,
          up: "CREATE TABLE IF NOT EXISTS investments (\x0a                  local_authority VARCHAR NOT NULL\x0a                , year SMALLINT NOT NULL\x0a                , investment VARCHAR NOT NULL\x0a                , value NUMERIC NOT NULL\x0a                );\x0a                ",
          down: "DROP TABLE IF EXISTS investments;",
          description: "Create investments table"
      };
  };
  var addRefreshTokenColumn = function (id) {
      return {
          id: id,
          up: "ALTER TABLE users\x0a                ADD COLUMN refresh_token VARCHAR;\x0a             ",
          down: "ALTER TABLE users DROP COLUMN refresh_token",
          description: "Add refresh token column"
      };
  };
  var migrations = [ createOAuthUserTable(1), addRefreshTokenColumn(2), createInvestmentsTable(3) ];
...
(function($PS) {
  ...
  var showScope = function (v) {
      ...
      throw new Error("Failed pattern match at JohnCowie.OAuth.Google (line 50, column 1 - line 50, column 29): " + [ v.constructor.name ]);
  };
  ...
  var redirect = function (options) {
      return function (config) {
          var query = queryString([ new Data_Tuple.Tuple("response_type", "code"), new Data_Tuple.Tuple("access_type", "offline"), Data_Tuple.Tuple.create("scope")(scopesStr(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Profile.value, Email.value ])(options.additionalScopes))), new Data_Tuple.Tuple("prompt", "select_account consent"), new Data_Tuple.Tuple("client_id", config.clientId), new Data_Tuple.Tuple("redirect_uri", config.callbackUrl) ]);
  ...
  var fetchOpenIdData = function (config) {
      return function (code) {
          ...
          return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Affjax.printError))(Affjax.request(request))))(function (response) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Either.Right.create)(Effect_Console.log(Data_Argonaut_Core.stringify(response.body))))))(function () {
                  return Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Argonaut_Decode_Error.printJsonDecodeError)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(JohnCowie_JWT.decodeJsonJWT)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(JohnCowie_JWT.decodeJsonJWT)(Data_Argonaut_Decode_Class.gDecodeJsonCons(JohnCowie_JWT.decodeJsonJWT)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          ...
          return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(fetchOpenIdData(config)(code)))(function (tokenData) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(JohnCowie_JWT.extractPayload(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))({
                      ...
                      refreshToken: Data_Newtype.unwrap(JohnCowie_JWT.newtypeJWT)(tokenData.refresh_token)
                  });
              });
          }));
      };
  ...
  var oauth = function (options) {
      return Envisage_Internal.mkComponent()()(Envisage_Record.recordUpdateCons(new Data_Symbol.IsSymbol(function () {
          ...
          return {
              component: {
                  redirect: redirect(options)(config),
...
(function($PS) {
  ...
  var stubGoogleOAuth = Envisage_Internal.mkComponent()()(Envisage_Record.recordUpdateNil(Envisage_Logger.applicativeReaderLogger(Data_Monoid.monoidArray)(Data_Maybe.applicativeMaybe))(Type_Equality.refl))({})(Data_Function["const"]({
      component: JohnCowie_OAuth_Stub.oauth("http://localhost:9000/google"),
      config: Data_Monoid.mempty(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
          return "apiUrl";
  ...
  var showMode = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 30, column 1 - line 32, column 21): " + [ v.constructor.name ]);
  });
  var serverErrorResponse = function (err) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.error(err)))(function () {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(JohnCowie_HTTPure.response(500)("A server error"));
      });
  };
  var serverConfig = {
      ...
      return function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v.value0 instanceof Fundoscopic_Routing.Login) {
                  return Fundoscopic_Middleware_Log.wrapLogRequest(Data_Unit.showUnit)(Fundoscopic_Handlers.login(Effect_Aff.monadAff)(deps.oauth.component));
              };
              if (v.value0 instanceof Fundoscopic_Routing.GoogleOAuthCallback) {
                  return JohnCowie_HTTPure_Middleware_QueryParams.wrapParseQueryParams(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsCons(JohnCowie_OAuth.oauthCodeParseQueryParam)(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsNil)(new Data_Symbol.IsSymbol(function () {
                      return "code";
                  }))()())()(Effect_Aff.bindAff)(Effect_Aff.applicativeAff)(JohnCowie_HTTPure.functorBasicRequest)(JohnCowie_HTTPure.requestBasicRequest)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.pure(Effect_Aff.applicativeAff))(errorsResponse))(JohnCowie_HTTPure_Middleware_Error.wrapHandleError(Effect_Aff.monadAff)(serverErrorResponse)(Fundoscopic_Handlers.googleOauthCallback(deps.db)(deps.oauth.component)(deps.jwt)));
              };
              if (v.value0 instanceof Fundoscopic_Routing.SheetTest) {
                  return Fundoscopic_Middleware_Auth.wrapTokenAuth(JohnCowie_JWT.newtypeJWT)(deps.jwt.verifyAndExtract)(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)(loginRedirect)))(JohnCowie_HTTPure_Middleware_QueryParams.wrapParseQueryParams(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsCons(JohnCowie_HTTPure_QueryParams.parseQueryParamString)(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsCons(JohnCowie_HTTPure_QueryParams.parseQueryParamString)(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsCons(JohnCowie_HTTPure_QueryParams.parseQueryParamString)(JohnCowie_HTTPure_QueryParams.gDecodeQueryParamsNil)(new Data_Symbol.IsSymbol(function () {
                      return "spreadsheet_sheet_id";
                  }))()())(new Data_Symbol.IsSymbol(function () {
                      return "sheet_name";
                  }))()())(new Data_Symbol.IsSymbol(function () {
                      return "fund_name";
                  }))()())()(Effect_Aff.bindAff)(Effect_Aff.applicativeAff)(Fundoscopic_Middleware_Auth.functorAuthedRequest)(Fundoscopic_Middleware_Auth.requestAuthedRequest)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.pure(Effect_Aff.applicativeAff))(errorsResponse))(JohnCowie_HTTPure_Middleware_Error.wrapHandleError(Effect_Aff.monadAff)(Fundoscopic_Error.plainErrorResponse)(Fundoscopic_Handlers.spreadsheet(deps.db)(deps.oauth.config))));
              };
              throw new Error("Failed pattern match at Main (line 55, column 14 - line 66, column 59): " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 53, column 22 - line 66, column 59): " + [ v.constructor.name ]);
      };
  };
          ...
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Envisage_Console.printErrorsForConsole)(Envisage_Internal.readEnv()()(Envisage_Record.recordUpdateCons(new Data_Symbol.IsSymbol(function () {
              ...
              oauth: (function () {
                  if (mode instanceof Dev) {
                      return stubGoogleOAuth;
                  };
                  if (mode instanceof Prod) {
                      return JohnCowie_OAuth_Google.oauth({
                          additionalScopes: [ JohnCowie_OAuth_Google.SpreadSheets.value ]
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 105, column 14 - line 107, column 71): " + [ mode.constructor.name ]);
              })(),
              server: serverConfig,
  ...
  exports["stubGoogleOAuth"] = stubGoogleOAuth;
