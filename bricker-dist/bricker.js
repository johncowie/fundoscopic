...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Bricker.compileTasks(Data_Ord.ordString)(Data_Show.showString)(lowercaseId)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Bricker.chainTasks(Data_Ord.ordString)("build")([ "clean", "build-html", "build-js", "deploy" ]))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Bricker.cmd(Data_Ord.ordString)("setup-deploy-branch")("\x0a          git branch -D server-dist || echo \"no branch\" &&\x0a          git checkout --orphan server-dist &&\x0a          git reset --hard && git commit --allow-empty -m \"Init\" &&\x0a          git checkout master &&\x0a          rm -rf server-dist &&\x0a          git worktree add server-dist server-dist\x0a        "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Bricker.cmd(Data_Ord.ordString)("clean-server")("rm -f server-dist/*.js"))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Bricker.cmd(Data_Ord.ordString)("build-server")("spago bundle-app --main Main --to server-dist/server.js"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Bricker.cmd(Data_Ord.ordString)("bundle-server")("npx noderify server-dist/server.js -o server-dist/server.bundle.js"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Bricker.cmd(Data_Ord.ordString)("deploy-server")("cd server-dist && git add . && git commit --allow-empty -m \"New build\" && git push -f heroku server-dist:master"))(function () {
                          return Bricker.chainTasks(Data_Ord.ordString)("release-server")([ "clean-server", "build-server", "bundle-server", "deploy-server" ]);
                      });
                  });
              });
          });
